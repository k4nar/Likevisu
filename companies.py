# Non-exhaustive list of employers with domain mails
# Originally taken from GitDM (http://repo.or.cz/w/git-dm.git)
domains = {
    ...
    "via.com.tw": "Via",
    "visionengravers.com": "Western Engravers Supply",
